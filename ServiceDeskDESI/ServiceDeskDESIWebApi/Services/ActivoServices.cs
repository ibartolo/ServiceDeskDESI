    ...
    public class ActivoService
    {
        ...
        public ModelResponse ObtenerTodosLosActivos(string usuario)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new ModelResponse { IsSuccess = false, Message = "Ocurrió un error al obtener los activos." };
            }
        }
        ...
        public ModelResponse ObtenerActivoPorId(long id, string usuario)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new ModelResponse { IsSuccess = false, Message = "Ocurrió un error al obtener el activo." };
            }
        }

        public ModelResponse GuardarOActualizarActivo(Activo activo, string usuario)
        {
            try
            {
                ...
                if (activo.TipoActivo == null || activo.TipoActivo.Id <= 0) { throw new ArgumentException("El tipo de activo es requerido."); }
                if (activo.Marca == null || activo.Marca.Id <= 0) { throw new ArgumentException("La marca es requerida."); }
                if (activo.Modelo == null || activo.Modelo.Id <= 0) { throw new ArgumentException("El modelo es requerido."); }
            ...
            catch (Exception ex)
            {
                ...
                return new ModelResponse { IsSuccess = false, Message = "Ocurrió un error al guardar el activo." };
            }
        }
