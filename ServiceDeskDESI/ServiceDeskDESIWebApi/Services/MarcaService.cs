    ...
    public class MarcaService
    {
        ...
        public ModelResponse<List<Marca>> ObtenerMarcas(string usuario)
        {
            try
            {
                ...
                Log.Information("MarcaService.ObtenerMarcas ENTRADA: {Json}", LogSanitizer.ToJson(new { usuario }));
                ...
                Log.Information("MarcaService.ObtenerMarcas SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
        ...
        public ModelResponse<Marca> ObtenerMarcaPorId(long id, string usuario)
        {
            try
            {
                ...
                Log.Information("MarcaService.ObtenerMarcaPorId ENTRADA: {Json}", LogSanitizer.ToJson(new { id, usuario }));
                ...
                Log.Information("MarcaService.ObtenerMarcaPorId SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
        ...
        public ModelResponse<Marca> GuardarOActualizarMarca(Marca marca, string usuario)
        {
            try
            {
                ...
                Log.Information("MarcaService.GuardarOActualizarMarca ENTRADA: {Json}", LogSanitizer.ToJson(new { marca, usuario }));
                ...
                Log.Information("MarcaService.GuardarOActualizarMarca SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
        ...
        public ModelResponse EliminarMarca(long id, string modificadoPor, DateTime fechaModificacion, string usuario)
        {
            try
            {
                ...
                Log.Information("MarcaService.EliminarMarca ENTRADA: {Json}", LogSanitizer.ToJson(new { id, modificadoPor, fechaModificacion, usuario }));
                ...
                Log.Information("MarcaService.EliminarMarca SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
