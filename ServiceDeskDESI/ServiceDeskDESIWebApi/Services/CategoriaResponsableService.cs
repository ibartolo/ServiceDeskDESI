    ...
    public class CategoriaResponsableService
    {
        ...
        public ModelResponse<List<CategoriaResponsableDTO>> ObtenerResponsablesPorCategoria(long categoriaId, string usuario)
        {
            try
            {
                ...
                Log.Information("CategoriaResponsableService.ObtenerResponsablesPorCategoria ENTRADA: {Json}", LogSanitizer.ToJson(new { categoriaId, usuario }));
                ...
                Log.Information("CategoriaResponsableService.ObtenerResponsablesPorCategoria SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
        ...
        public ModelResponse<List<CategoriaResponsableDTO>> ObtenerCategoriasPorResponsable(long usuarioId, string usuario)
        {
            try
            {
                ...
                Log.Information("CategoriaResponsableService.ObtenerCategoriasPorResponsable ENTRADA: {Json}", LogSanitizer.ToJson(new { usuarioId, usuario }));
                ...
                Log.Information("CategoriaResponsableService.ObtenerCategoriasPorResponsable SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
        ...
        public ModelResponse<CategoriaResponsable> GuardarOActualizarCategoriaResponsable(CategoriaResponsable categoriaResponsable, string usuario)
        {
            try
            {
                ...
                Log.Information("CategoriaResponsableService.GuardarOActualizarCategoriaResponsable ENTRADA: {Json}", LogSanitizer.ToJson(new { categoriaResponsable, usuario }));
                ...
                Log.Information("CategoriaResponsableService.GuardarOActualizarCategoriaResponsable SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
        ...
        public ModelResponse EliminarCategoriaResponsable(long id, string modificadoPor, DateTime fechaModificacion, string usuario)
        {
            try
            {
                ...
                Log.Information("CategoriaResponsableService.EliminarCategoriaResponsable ENTRADA: {Json}", LogSanitizer.ToJson(new { id, modificadoPor, fechaModificacion, usuario }));
                ...
                Log.Information("CategoriaResponsableService.EliminarCategoriaResponsable SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
        ...
        public ModelResponse<List<CategoriaResponsableDTO>> ObtenerTodosLosResponsables(string usuario)
        {
            try
            {
                ...
                Log.Information("CategoriaResponsableService.ObtenerTodosLosResponsables ENTRADA: {Json}", LogSanitizer.ToJson(new { usuario }));
                ...
                Log.Information("CategoriaResponsableService.ObtenerTodosLosResponsables SALIDA: {Json}", LogSanitizer.ToJson(result));
                return result;
            }
            catch (ArgumentException ex)
            {
